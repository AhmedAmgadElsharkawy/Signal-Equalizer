...
mode_sliders_data = {
    ...
    "Animal Sounds":[slider_data("owl",[(650,950)]),slider_data("frog",[(1200, 1900)]),slider_data("insect",[(6000,20000)]),
                     slider_data("bass",[(0,550)]), slider_data("Xylophone", [(950, 1100), (1200, 1500)]), slider_data("Piano",[(0,650), (1900, 6000), (20000,30000)])],
}
