...
class CineSignalViewer(QWidget):
    def __init__(self):
        ...
        self.cine_signal_plot.getAxis('bottom').setPen(pg.mkPen('k'))  # Set bottom axis to black
        self.cine_signal_plot.getAxis('left').setPen(pg.mkPen('k'))
        self.cine_signal_plot.getAxis('bottom').setTextPen(pg.mkPen('k'))  # Bottom axis numbers to black
        self.cine_signal_plot.getAxis('left').setTextPen(pg.mkPen('k'))  # Left axis numbers to black
        ...
        self.spectrogram_figure.subplots_adjust(left=0.07, right=0.95, top=0.95, bottom=0.07)
